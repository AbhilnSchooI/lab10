...
public class TicTacToe {
    ...
    public static void main(String[] args) {
        ...
        while (!gameDone) {
            ...
            doneRound = false;
            while (!done) {
                temp = InputHelper.getNonZeroLenString(scan, "Player 1, choose Xs or Os.");
            ...
            while (!doneRound) {
                ...
                donePlayerTwo = false;
                while (!donePlayerOne){
                    playerOneMoveRow = InputHelper.getRangedInt(scan, 1, 3, "Pick a row for your move (Player 1)");
                    playerOneMoveCol = InputHelper.getRangedInt(scan,  1,3, "Pick a column for your move (Player 1)");
                ...
                while (!donePlayerTwo){
                    playerTwoMoveRow = InputHelper.getRangedInt(scan, 1, 3, "Pick a row for your move (Player 2)");
                    playerTwoMoveCol = InputHelper.getRangedInt(scan,  1,3, "Pick a column for your move (Player 2)");
            ...
            gameDone = InputHelper.YNConfirm(scan, "Play again?(Y/N)");
        }
    }
